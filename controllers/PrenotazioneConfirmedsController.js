...
exports.createNew = (req,res)=> {
      ...
      let strsql =  `insert into prenotazione_confirmeds
                  (cognome,nome,telefono,password,datapren,persone,email,token,codpren) 
                  valueS
                  (
                     '${cognome}','${nome}','${telefono}','${password}','${datapren}',${persone},'${email}','${token}','${codpren}' 
                  )`;
...
exports.getbytokencodpre = (req,res)=> {
   ...
   // const strsql = strSql + " where `prenotazione_confirmeds`.`token` = '" + token + "' and  `prenotazione_confirmeds`.`codpren` = '" + codpren + "' ";                           ";


    const where = " where `prenotazione_confirmeds`.`token` = '" + token + "' and `prenotazione_confirmeds`.`codpren` = '" + codpren + "' ";
...
exports.getbyemaildatapre = (req,res)=> {
 ...
 // const strsql = strSql + " where `prenotazione_confirmeds`.`email` = '" + email + "' and  `prenotazione_confirmeds`.`datapre` = '" + datapre + "' ";  
 const strsql = strSql + ` where 'prenotazione_confirmeds'.'email' = '${email}' and  'prenotazione_confirmeds'.'datapre' = '${datapre}'`;                        
