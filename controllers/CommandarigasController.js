...
exports.createNew = (req,res)=> {
    ...
    //  console.log(req.body,'Creazione nuovo commanda');  // visualizzo la struttura dei campi immessi dall'commanda 
      ...
      let strsql =  `insert into commandarigas
                  (idCommanda,idProdotto,categoria,competenza,descrizione_prodotto,prezzo,qta_ord,note_riga,key_utenti_operation) 
                  valueS
                  (
                     ${idCommanda},${idProdotto},${categoria},${competenza},'${descrizione_prodotto}',${prezzo},${qta_ord},'${note_riga}',${key_utenti_operation}
                  )`;
...
exports.getProdottibytipologiaeStato = (req,res)=> {
    ...
    const strsql = strSql + ' where `prodottos`.`tipologia` = ' + tipologia + ' and  `commandarigas`.`stato` = '  + stato  + sort;
