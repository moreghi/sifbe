...
// se faccio mysql.createPool
//  https://stackoverflow.com/questions/37102364/how-do-i-create-a-mysql-connection-pool-while-working-with-nodejs-and-express  google: mysql.createPool

db.on('connection', function (connection) {
    console.log('creata la connessione Mysql in Pool');
...
db.cassawc1 = require("./models/cassawc1.js")(sequelize, Sequelize);
...
db.cassasintetica = require("./models/cassasintetica.js")(sequelize, Sequelize);
